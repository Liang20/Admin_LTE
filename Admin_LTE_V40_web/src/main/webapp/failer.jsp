		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting3"><a href="${pageContext.request.contextPath}/role/findAll.do">
							<i class="fa fa-circle-o"></i> 角色管理
					</a></li>
					<li id="system-setting2"><a href="${pageContext.request.contextPath}/permission/findAll.do">
